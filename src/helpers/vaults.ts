...
const stables = [
  { protocol: 'Stablecoins', address: '0x049d68029688eabf473097a2fc38ef61633a3c7a', tokenSymbol: 'USDT' },
  { protocol: 'Stablecoins', address: '0x04068DA6C83AFCFA0e13ba15A6696662335D5B75', tokenSymbol: 'USDC' },
  { protocol: 'Stablecoins', address: '0x8D11eC38a3EB5E956B052f67Da8Bdc9bef8Abf3E', tokenSymbol: 'DAI' },
  { protocol: 'Stablecoins', address: '0x21be370d5312f44cb42ce377bc9b8a0cef1a4c83', tokenSymbol: 'WFTM' },
]

const aave = [
  { protocol: 'Aave', address: '0x6ab707Aca953eDAeFBc4fD23bA73294241490620', tokenSymbol: 'aUSDT' },
  { protocol: 'Aave', address: '0x625E7708f30cA75bfd92586e17077590C60eb4cD', tokenSymbol: 'aUSDC' },
  { protocol: 'Aave', address: '0x82E64f49Ed5EC1bC6e43DAD4FC8Af9bb3A2312EE', tokenSymbol: 'aDAI' },
]

const yearn = [
  { protocol: 'Yearn', address: '0x148c05caf1Bb09B5670f00D511718f733C54bC4c', tokenSymbol: 'USDT' },
  { protocol: 'Yearn', address: '0xEF0210eB96c7EB36AF8ed1c20306462764935607', tokenSymbol: 'USDC' },
  { protocol: 'Yearn', address: '0x637eC617c86D24E421328e6CAEa1d92114892439', tokenSymbol: 'DAI' },
]
